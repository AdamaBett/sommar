...
const STEPS: Step[] = [
  {
    ...
    description:
      'Uma conversa com nossa IA que te entende de verdade. Sem formulários. Em minutos, ela captura suas camadas: o que te move, o que você sabe fazer, o que busca, como se conecta.',
  ...
  },
  {
    ...
    description:
      'Não por aparência. Por essência, interesses e intenção. O Sommar cruza perfis profundos e mostra por que duas pessoas devem se encontrar — pode ser um amor, uma parceria, uma amizade.',
  ...
  },
  {
    ...
    description:
      'No evento, no momento certo. Troque mensagens com quem a IA sugeriu. O encontro acontece presencialmente, olho no olho. Vocês decidem o que nasce dali.',
              ...
              <GlassCard padding="lg" className="flex flex-col h-full">
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div
                    ...
                    style={{ background: `${step.glowColor}14` }}
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
