...
const MOCK_PROFILE = {
  ...
  active_facets: ['essencia', 'intimo', 'profissional', 'criativo', 'social'],
  facet_data: {
    essencia: {
      social_energy: 0.85,
    ...
    criativo: {
      interests: ['música', 'tecnologia', 'filosofia', 'experiências imersivas'],
    },
    social: {
  ...
  ori_narrative: {
    ...
    criativo: 'Suas referências vão de tech a filosofia, de música a experiências imersivas. Você conecta mundos que ninguém pensaria em juntar.',
